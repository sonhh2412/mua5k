(function() {
  ...
  angular.module('bgf.paginateAnything', []).
    ...
    directive('bgfPagination', function () {
      var defaultLinkGroupSize = 3, defaultClientLimit = 250, defaultPerPage = 28;
      ...
      return {
        ...
        templateUrl: function(element, attr) {
          ...
          return  '/bower_components/angular-paginate-anything/dist/paginate-anything.html';
        },
        replace: true,
        controller: ['$scope', '$attrs', '$http', function($scope, $attrs, $http) {
          ...
          function requestRange(request) {
            ...
            responsePromise.then(function (rsp) {
              ...
              $scope.total = $scope.numPages ;

              $scope.$emit('pagination:loadPage', rsp.status, rsp.config);
              $scope.current = $scope.page;
              'undefined' === typeof $scope.gotopage && ($scope.gotopage = $scope.gotoPage);
